...
export default function Dashboard() {
  ...
  return (
    <VantaBackground overlayOpacity={0.9}>
      <div
        className="fixed top-0 left-0 w-full flex justify-center z-50 pointer-events-none transition"
        style={{
          transform: `translateY(${pullDistance}px)`,
          opacity: pullDistance > 5 ? 1 : 0,
        }}
      >
        <div className="mt-4 px-4 py-2 rounded-full bg-black/70 border border-zinc-700 text-sm text-white shadow-lg">
